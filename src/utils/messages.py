...
nft_search_msg = 'Что хотите найти?'

nft_search_collection_msg = 'Введите адрес коллекции'
...
nft_contract_error_msg = 'Вы ввели неправильный адрес NFT'

# App
app_msg = 'Приложения на TON'
